...
function tilesetParser.loadTerrain()
    ...
    terrain["o_l"] = parseTile(source, 2, 1)
    terrain["o_r"] = parseTile(source, 0, 1)
    terrain["o_d"] = parseTile(source, 1, 0)
    terrain["o_dl"] = parseTile(source, 4, 0)
    terrain["o_dr"] = parseTile(source, 3, 0)
    terrain["o_e_dr"] = parseTile(source, 0, 0)
    terrain["o_e_or"] = parseTile(source, 0, 2)
    terrain["o_e_dl"] = parseTile(source, 2, 0)
    terrain["o_e_ol"] = parseTile(source, 2, 2)
